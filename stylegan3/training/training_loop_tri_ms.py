...
def training_loop(
    ...
    while True:
        ...
        with torch.autograd.profiler.record_function('data_fetch'):
            ...
            all_gen_z = [phase_gen_z.split(batch_gpu * 3) for phase_gen_z in all_gen_z.split(batch_size * 3)]
            ## source 1
            ...
            all_gen_c = [phase_gen_c.split(batch_gpu * 3) for phase_gen_c in all_gen_c.split(batch_size * 3)]
