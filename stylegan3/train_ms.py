...
import dnnlib
from training import training_loop_ms
...
def subprocess_fn(rank, c, temp_dir):
    ...
    training_loop_ms.training_loop(rank=rank, **c)
...
@click.option('--use_ground_truth', help='the way to estimate the latent space', metavar='BOOL', type=bool, required=True)
...
@click.option('--snap',         help='How often to save snapshots', metavar='TICKS',            type=click.IntRange(min=1), default=160, show_default=True)
