...
## StyleGAN-T
## Multi-Source
srun ~/conda3/envs/stylegan3_test/bin/python ~/projects/causal_gans/stylegan3/evaluations/eval_general_fids.py --outdir ~/experiments/multisources/ukb/fids/ --dataset ukb --data-path1 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source1/ --data-path2 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source2/ --num-samples 50000 --source-gan multi --network /dhc/home/wei-cheng.lai/experiments/multisources/ukb/stylegan-t/00004-stylegan3-t-condTrue-multisource-ukb-augnoaug-gpus2-batch128-gamma4-kimg6000/metric-fid50k_full.jsonl

## Single-Source
## Source1
srun ~/conda3/envs/stylegan3_test/bin/python ~/projects/causal_gans/stylegan3/evaluations/eval_general_fids.py --outdir ~/experiments/singlesource/ukb/plots/source1/fids/ --dataset ukb --data-path1 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source1/ --source-gan single --num-samples 50000 --network /dhc/home/wei-cheng.lai/experiments/singlesource/ukb/source1/stylegan-t/00004-stylegan3-t-condTrue-ukb-augnoaug-gpus1-batch128-gamma4-kimg3000/metric-fid50k_full.jsonl

## Source2
srun ~/conda3/envs/stylegan3_test/bin/python ~/projects/causal_gans/stylegan3/evaluations/eval_general_fids.py --outdir ~/experiments/singlesource/ukb/plots/source2/fids/ --dataset ukb --data-path1 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source2/ --source-gan single --num-samples 50000 --network /dhc/home/wei-cheng.lai/experiments/singlesource/ukb/source2/stylegan-t/00005-stylegan3-t-condTrue-ukb-augnoaug-gpus1-batch128-gamma4-kimg4000/metric-fid50k_full.jsonl


### Single Source but with two datasets
## source 1
srun ~/conda3/envs/stylegan3_test/bin/python ~/projects/causal_gans/stylegan3/evaluations/eval_general_fids.py --outdir ~/experiments/singlesource/ukb/plots/source1/fids/ --dataset ukb --data-path1 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source1/ --data-path2 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source2/ --source-gan single --num-samples 50000 --network /dhc/home/wei-cheng.lai/experiments/singlesource/ukb/source1/stylegan-t/00004-stylegan3-t-condTrue-ukb-augnoaug-gpus1-batch128-gamma4-kimg3000/metric-fid50k_full.jsonl

## source 2
srun ~/conda3/envs/stylegan3_test/bin/python ~/projects/causal_gans/stylegan3/evaluations/eval_general_fids.py --outdir ~/experiments/singlesource/ukb/plots/source2/fids/ --dataset ukb --data-path1 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source2/ --data-path2 /scratch/wei-cheng.lai/T1_3T_coronal_mni_linear_freesurfer_resolution256_source1/ --source-gan single --num-samples 50000 --network /dhc/home/wei-cheng.lai/experiments/singlesource/ukb/source2/stylegan-t/00005-stylegan3-t-condTrue-ukb-augnoaug-gpus1-batch128-gamma4-kimg4000/metric-fid50k_full.jsonl
